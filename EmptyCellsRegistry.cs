...
namespace Balls
{
    class EmptyCellsRegistry
    {
        ...
        public void addCell(Cell NovePole)//Vloží pole do registru.
        {
        ...
        public Cell getCell(int Poradi)//Vrátí dané prázdné pole z registru a zároveň toto pole vymaže z registru.
        {
            if (Poradi <= getCountOfNodes())
            {
                if (Poradi == 1)
                {
        ...
        public void removeCell(Cell novePlnePole)//Vrátí dané prázdné pole z registru a zároveň toto pole vymaže z registru.
        {
